...
export const SignUpForm = () => {
  ...
  return (
    <div className="grid grid-cols-3 grid-flow-col gap-2">
      <div className="col-span-1 flex flex-col justify-center p-4 text-white">
      ...
      <div className="col-span-2 md:col-span-2 lg:col-span-2 p-4 z-20 text-white justify-end items-end ">
        <Formik
